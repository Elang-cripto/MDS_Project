...
function sidebarType(e) {
    ...
    if ((d.classList.add(s), "bg-default" == s)) {
...
function toggleNavLinksColor(e) {
    ...
    "blur" === e
        ? (t.forEach((e) => {
          ...
          s.forEach((e) => {
              e.classList.add("bg-dark"), e.classList.remove("bg-default");
          }))
        : "transparent" === e &&
          (t.forEach((e) => {
          ...
          s.forEach((e) => {
              e.classList.remove("bg-dark"), e.classList.add("bg-default");
          }));
}
function navbarBlurOnScroll(e) {
    ...
    let a = ["bg-default", "left-auto", "position-sticky"],
        n = ["shadow-none"];
    function i() {
        t.classList.add(...a),
...
function darkMode(e) {
    const t = document.getElementsByTagName("body")[0],
        ...
        n = document.querySelectorAll(".sidenav.bg-default"),
    ...
    if (e.getAttribute("checked")) {
        ...
        for (var A = 0; A < n.length; A++) n[A].classList.remove("bg-default");
